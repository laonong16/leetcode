  ...
  "3, 4"
    ...
    public static void main (String[] args) {
        String[] employees = new String[]{
                ...
                "4, Richard, Business",
                "6, Tom, Engineer"};
        String[] firendships = new String[] {
                "1, 2",
                "1, 3",
                "3, 4"
        };
        System.out.println(friendCycle1(employees, firendships));
        System.out.println(friendCycle2(employees, firendships));
...
*/
     public static List<String> friendCycle1(String[] employees, String[] friendships){
         ...
         for(String pair : friendships){
             //employeeA is friend with employeeB, employeeB is friend with employeeA
             String[] sep = pair.split(",");
             String employeeA = sep[0];
             String[] meaningless_split = sep[1].split(" ");
             String employeeB = meaningless_split[1];
             friend_list.get(employeeA).add(employeeB);
             friend_list.get(employeeB).add(employeeA);
         }
